import{_ as s,c as n,o as a,S as l}from"./chunks/framework.3EKbrk2Y.js";const u=JSON.parse('{"title":"Go语言：标识符、关键字、预定义标识符和自定义标识符","description":"","frontmatter":{"title":"Go语言：标识符、关键字、预定义标识符和自定义标识符","date":"2023-09-08T11:42:00.000Z","thumbnail":"/assets/golang.jpg"},"headers":[],"relativePath":"go/ident/index.md","filePath":"go/ident/index.md"}'),p={name:"go/ident/index.md"},o=l(`<p>标识符，用于标记各种编程元素，例如变量、函数和类型等。标识符由字符组成，Go 语言使用 unicode 字符集，标识符的命名需要遵守以下规则：</p><ul><li>以字母下划线开头 + 字母/数字/下划线。注：字母指 unicode 中的字符，所以中文也是可以的</li><li>区分大小写。在包中，首字母大小写还有特殊意义，大写表示导出，小写表示私有</li><li>部分标识符已经保留不可以使用，称为关键字</li><li>部分标识符已有意义不建议使用，称为预定义标识符</li></ul><h2 id="关键字" tabindex="-1">关键字 <a class="header-anchor" href="#关键字" aria-label="Permalink to &quot;关键字&quot;">​</a></h2><p>Go 语言目前有 25 个关键字，不能用作标识符，介绍和示例如下：</p><div class="language-go"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6A737D;">// package：声明包的名字，与文件夹名字无关，但通常与文件夹名字保持一致</span></span>
