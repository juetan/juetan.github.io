...
<span class="line"><span style="color:#24292E;">_, err </span><span style="color:#D73A49;">=</span><span style="color:#005CC5;"> run</span><span style="color:#24292E;">()</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h2><p>以上。标识符首字母不能为数字，且大小写敏感。使用标识符作为变量名时，关键字不可以使用，预定义标识符不建议使用，自定义标识符需注意首字母大写和下划线(_)。</p>`,13),r=[e];function o(c,t,i,b,y,u){return n(),a("div",null,r)}const A=s(p,[["render",o]]);export{d as __pageData,A as default};
