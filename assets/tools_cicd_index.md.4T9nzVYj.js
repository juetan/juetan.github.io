import{_ as s,c as n,o as a,S as l}from"./chunks/framework.3EKbrk2Y.js";const A=JSON.parse('{"title":"搭建一套适用于个人的CICD构建流系统","description":"","frontmatter":{"title":"搭建一套适用于个人的CICD构建流系统","date":"2023-07-21T18:00:00.000Z"},"headers":[],"relativePath":"tools/cicd/index.md","filePath":"tools/cicd/index.md"}'),p={name:"tools/cicd/index.md"},e=l(`<p>在如今的容器服务中，使用Gitlab、K8S、Jenkins等技术部署服务是非常常见的，但这些需要的服务器内存和数量都不小。例如，部署一个Gitlab都需要至少4G内存，对于个人学习属实不太友好。</p><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>基于docker，实现面向个人的CICD集成，包括：</p><ul><li>基于 docker + swarm + traefik + portainer 的容器平台。</li><li>基于 mysql + gitea + droneci + docker registry的构建平台。</li></ul><p>要求：</p><ul><li>至少1台安装好 docker 的服务器/虚拟机。备注：最好2台，一台为主服务器，一台为子服务器。</li><li>至少1个域名。备注：域名解析到国内服务器需备案</li><li>具备docker基本操作知识</li></ul><p>实践项目</p><ul><li>前后端分离项目(VueJS + NestJS)</li></ul><p>准备工作</p><ul><li>将<code>*.dev.juetan.cn</code>解析到主服务器，用于基础设施的访问</li><li>将<code>*.app.juetan.cn</code>解析到主服务器，用于部署应用的访问</li><li>在主服务器上，新建<code>/docker</code>目录</li></ul><h2 id="准备工作" tabindex="-1">准备工作 <a class="header-anchor" href="#准备工作" aria-label="Permalink to &quot;准备工作&quot;">​</a></h2><p>在开始前，需要做很多准备</p><h3 id="创建集群" tabindex="-1">创建集群 <a class="header-anchor" href="#创建集群" aria-label="Permalink to &quot;创建集群&quot;">​</a></h3><p>Docker 的 Swarm 模式表示集群， 允许在一台主服务器上，管理多台子服务器的容器和状态。</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6A737D;"># 在主服务器上，初始化docker集群</span></span>
...
<span class="line"><span style="color:#6F42C1;">docker</span><span style="color:#032F62;"> swarm</span><span style="color:#032F62;"> jorin</span><span style="color:#005CC5;"> --token</span><span style="color:#032F62;"> xx</span><span style="color:#032F62;"> ip:port</span></span></code></pre></div><h3 id="管理面板" tabindex="-1">管理面板 <a class="header-anchor" href="#管理面板" aria-label="Permalink to &quot;管理面板&quot;">​</a></h3><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">version</span><span style="color:#24292E;">: </span><span style="color:#032F62;">&quot;3&quot;</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#22863A;">volumes</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">  valume_portainer</span><span style="color:#24292E;">:</span></span></code></pre></div><h3 id="创建用户" tabindex="-1">创建用户 <a class="header-anchor" href="#创建用户" aria-label="Permalink to &quot;创建用户&quot;">​</a></h3><p>在主服务器上，创建1个将分配给<code>droneci</code>使用的用户，用于远程更新容器</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6A737D;"># 创建用户</span></span>
...
<span class="line"><span style="color:#6F42C1;">service</span><span style="color:#032F62;"> ssh</span><span style="color:#032F62;"> restart</span></span></code></pre></div><h2 id="核心服务" tabindex="-1">核心服务 <a class="header-anchor" href="#核心服务" aria-label="Permalink to &quot;核心服务&quot;">​</a></h2><h3 id="添加核心容器" tabindex="-1">添加核心容器 <a class="header-anchor" href="#添加核心容器" aria-label="Permalink to &quot;添加核心容器&quot;">​</a></h3><p>修改<code>/docker/core.toml</code>文件，添加内容如下</p><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">version</span><span style="color:#24292E;">: </span><span style="color:#032F62;">&quot;3&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#22863A;">services</span><span style="color:#24292E;">:</span></span>
...
<span class="line"><span style="color:#22863A;">    external</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">true</span></span></code></pre></div><ol start="2"><li>运行以下命令启动</li></ol><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6F42C1;">docker</span><span style="color:#032F62;"> stack</span><span style="color:#032F62;"> deploy</span><span style="color:#005CC5;"> -c</span><span style="color:#032F62;"> /docker/core.yml</span><span style="color:#032F62;"> core</span></span></code></pre></div><h2 id="开发服务" tabindex="-1">开发服务 <a class="header-anchor" href="#开发服务" aria-label="Permalink to &quot;开发服务&quot;">​</a></h2><h3 id="创建开发流所需的容器" tabindex="-1">创建开发流所需的容器 <a class="header-anchor" href="#创建开发流所需的容器" aria-label="Permalink to &quot;创建开发流所需的容器&quot;">​</a></h3><ol><li>在<code>Portainer</code>页面中，依次选择<code>Stacks</code>- <code>Add Stack</code>，填写<code>name</code>为<code>base</code>，内容如下：</li></ol><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">version</span><span style="color:#24292E;">: </span><span style="color:#032F62;">&#39;3&#39;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#22863A;">services</span><span style="color:#24292E;">:</span></span>
...
<span class="line"><span style="color:#22863A;">    external</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">true</span></span></code></pre></div><ol start="2"><li>点击<code>Deploy the stack</code>，等待服务部署完成。</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-light vp-code"><code><span class="line"><span>可能会比较慢</span></span></code></pre></div><ol start="3"><li>使用<code>DBeaver</code>或其他数据库管理软件连接<code>Mysql</code>，创建数据库<code>gitea</code>。</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-light vp-code"><code><span class="line"><span>https://dbeaver.io/</span></span></code></pre></div><ol start="4"><li>访问<code>https://git.dev.juetan.cn</code>完成创建，点击<code>设置-应用</code>创建应用如下：</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-light vp-code"><code><span class="line"><span>应用名称：DroneCI(可任意名称)</span></span>
<span class="line"><span>重定向地址：https://ci.dev.juetan.cn/login</span></span></code></pre></div><ol start="5"><li>复制客户端ID和客户端密钥，更新core.yml文件，然后重启服务</li></ol><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6A737D;"># core.yml</span></span>
<span class="line"><span style="color:#22863A;">services</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">  drone-server</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">    image</span><span style="color:#24292E;">: </span><span style="color:#032F62;">drone/drone:latest</span></span>
<span class="line"><span style="color:#22863A;">    environment</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#24292E;">      - </span><span style="color:#032F62;">DRONE_GITEA_CLIENT_ID=此处填写间客户端ID</span></span>
<span class="line"><span style="color:#24292E;">      - </span><span style="color:#032F62;">DRONE_GITEA_CLIENT_SECRET=此处填写客户端密钥</span></span></code></pre></div><h2 id="项目实践" tabindex="-1">项目实践 <a class="header-anchor" href="#项目实践" aria-label="Permalink to &quot;项目实践&quot;">​</a></h2><p>接下来是项目实践，部署一个前后端分离，前端为VueJS，后端为NestJS的项目。</p><h3 id="前端配置" tabindex="-1">前端配置 <a class="header-anchor" href="#前端配置" aria-label="Permalink to &quot;前端配置&quot;">​</a></h3><ol><li>在根目录下新建<code>.drone.yml</code>文件，添加如下内容：</li></ol><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">kind</span><span style="color:#24292E;">: </span><span style="color:#032F62;">pipeline</span></span>
...
<span class="line"><span style="color:#24292E;">        - </span><span style="color:#032F62;">docker service update --image registry.dev.juetan.cn/web:latest app1_web</span></span></code></pre></div><ol start="2"><li>在根目录下新建<code>Dockerfile</code>文件，添加如下内容：</li></ol><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6F42C1;">FROM</span><span style="color:#032F62;"> nginx</span></span>
...
<span class="line"><span style="color:#6F42C1;">ENTRYPOINT</span><span style="color:#24292E;"> [</span><span style="color:#032F62;">&quot;nginx&quot;</span><span style="color:#24292E;">,</span><span style="color:#032F62;">&quot;-g&quot;</span><span style="color:#24292E;">,</span><span style="color:#032F62;">&quot;daemon off;&quot;</span><span style="color:#24292E;">]</span></span></code></pre></div><h3 id="后端配置" tabindex="-1">后端配置 <a class="header-anchor" href="#后端配置" aria-label="Permalink to &quot;后端配置&quot;">​</a></h3><ol><li>在根目录下新建<code>.drone.yml</code>文件，添加如下内容：</li></ol><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">kind</span><span style="color:#24292E;">: </span><span style="color:#032F62;">pipeline</span></span>
<span class="line"><span style="color:#22863A;">name</span><span style="color:#24292E;">: </span><span style="color:#032F62;">default</span></span>
<span class="line"><span style="color:#22863A;">steps</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#24292E;">  - </span><span style="color:#22863A;">name</span><span style="color:#24292E;">: </span><span style="color:#032F62;">build</span></span>
...
<span class="line"><span style="color:#22863A;">        from_secret</span><span style="color:#24292E;">: </span><span style="color:#032F62;">DEPLOY_PORT</span></span>
<span class="line"><span style="color:#22863A;">      script</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#24292E;">        - </span><span style="color:#032F62;">docker service update --image registry.dev.juetan.cn/server:latest app1_server</span></span></code></pre></div><ol start="2"><li>在根目录下新建<code>Dockerfile</code>文件，添加如下内容：</li></ol><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#6F42C1;">FROM</span><span style="color:#032F62;"> node:latest</span></span>
<span class="line"><span style="color:#6F42C1;">COPY</span><span style="color:#032F62;"> .</span><span style="color:#032F62;"> .</span></span>
<span class="line"><span style="color:#6F42C1;">ENTRYPOINT</span><span style="color:#24292E;"> [</span><span style="color:#032F62;">&quot;npm&quot;</span><span style="color:#24292E;">,</span><span style="color:#032F62;">&quot;run&quot;</span><span style="color:#24292E;">,</span><span style="color:#032F62;">&quot;start&quot;</span><span style="color:#24292E;">]</span></span></code></pre></div><h3 id="部署配置" tabindex="-1">部署配置 <a class="header-anchor" href="#部署配置" aria-label="Permalink to &quot;部署配置&quot;">​</a></h3><ol><li>在<code>Portainer</code>页面中，依次选择<code>Stacks</code>- <code>Add Stack</code>，填写<code>name</code>为<code>ssv</code>，内容如下：</li></ol><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#22863A;">version</span><span style="color:#24292E;">: </span><span style="color:#032F62;">&quot;3&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#22863A;">services</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">  server</span><span style="color:#24292E;">:</span></span>
...
<span class="line"><span style="color:#22863A;">networks</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">  public</span><span style="color:#24292E;">:</span></span>
<span class="line"><span style="color:#22863A;">    external</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">true</span></span></code></pre></div><ol start="2"><li>点击<code>Deploy the stack</code>按钮，等待服务部署完成，访问如下连接即可：</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-light vp-code"><code><span class="line"><span>http://web.dev.juetan.cn</span></span></code></pre></div><h2 id="结语" tabindex="-1">结语 <a class="header-anchor" href="#结语" aria-label="Permalink to &quot;结语&quot;">​</a></h2><ul><li>仓库地址：<a href="https://github.com/juetan/devops-practice" target="_blank" rel="noreferrer">https://github.com/juetan/devops-practice</a></li></ul>`,57),o=[e];function c(t,r,y,i,E,d){return a(),n("div",null,o)}const F=s(p,[["render",c]]);export{A as __pageData,F as default};
